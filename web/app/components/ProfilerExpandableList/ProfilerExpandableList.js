          ...
          Object.keys(data).map((k, index) => {
            ...
            return (
              ...
              >
                {
                  ({ h }) => (
                    <div className="profiler-expandable-listview-wrapper" key={k}>
                      <ListHeader
                        header={header}
                        headerIndex={index}
                        className="profiler-expandable-listview_listHeader"
                        isOpened={isOpened}
                      ...
                      >
                        <ListItemsManager
                          ...
                          className="profiler-expandable-listview_listItems"
                        />
                      </div>
                    </div>
                  )
